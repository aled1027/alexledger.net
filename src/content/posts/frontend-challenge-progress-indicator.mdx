...
This is my solution of the [progress indicator frontend coding challenge](https://piccalil.li/blog/challenge-009-progress-indicator) from [piccalil](https://piccalil.li/).
