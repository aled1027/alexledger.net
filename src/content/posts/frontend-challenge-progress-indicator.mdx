...
This is my solution to [frontend coding challenge: progress indicator](https://piccalil.li/blog/challenge-009-progress-indicator) from [piccalil](https://piccalil.li/).
